...
let g:python_host_prog = expand('~/.pyenv/versions/neovim-python-2.7.17/bin/python')
let g:python3_host_prog = expand('~/.pyenv/versions/neovim-python-3.8.0/bin/python3')
